...
}:
{
  ...
  users.users.${username}.openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIK2ENAFTKtYn3cT9x8l+4BJkrvg1ZTF2LTFOkONTz1OD liv@iris" # iris@windows
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIN7Qlz0vKb8EtqiyRRz1PLmcWR9mxq39BaAcUU4Ls2pM liv@april" # april
